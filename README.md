...
| `009_lock_album_owner_updates.sql` | Prevent direct `albums.user_id` ownership changes |
| `010_transfer_ownership.sql` | Owner transfer RPC with marketplace metadata cleanup |
